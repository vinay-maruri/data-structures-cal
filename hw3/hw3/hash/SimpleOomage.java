 ...
 * @version: 1.4
 * @purpose: to better understand hash tables
 */
package hw3.hash;
...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        SimpleOomage check = (SimpleOomage) o;
        return (this.red == check.red) && (this.green == check.green)
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            int hashcode = 1;
            hashcode += (204 * 204 * (red / 5)) + (204 * (green / 5)) + (blue / 5);
            return hashcode;
        }
    }
