...
public class HexWorld {
    ...
    /**
     * method to add hexagon objects to our world
     * @param world world to draw on
     * @param p bottom left coordinate of the hexagon
    ...
    public static void addHexagon(TETile[][] world, Position p, int s, TETile t) {
        ...
        for(int i = 0; i < 2 * s; i++) {
            int rowY = p.y + i;
            int xStart = p.x + hexRowOffset(s, i);
            Position rowstartP = new Position(xStart, rowY);
