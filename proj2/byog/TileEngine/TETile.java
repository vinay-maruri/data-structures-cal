...
public class TETile implements Serializable {
     ...
     * @param description     The description of the tile, shown in
     *                        the GUI on hovering over the tile.
    ...
    /**
     * Constructor without filepath. In this case, filepath
     * will be null, so when drawing, we
