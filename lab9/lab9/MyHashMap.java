...
public class MyHashMap<K, V> implements Map61B<K, V> {
    ...
    public V get(K key) {
        ...
        int keytoretrieve = hash(key);
        return buckets[keytoretrieve].get(key);
    }
    ...
    public void put(K key, V value) {
        ...
        int insertvalue = hash(key);
        buckets[insertvalue].put(key, value);
    }

    /* private helper method to resize the arraymap. */
